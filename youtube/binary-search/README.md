...
It means whether the array is in Ascending order or Descending order, but you don't know which one it is. But it is a **Sorted Array**
...
## GFG - Find position element Sorted Array infinite numbers
...
## Peak index in a mountain array and Find peak element
